...
const fetchRecordUser = async ({ queryKey }) => {
   // Delaying function
   ...
   if (id) {
      ...
      const results = await fetch(`https://api1.technolashes.com/api/record/user/${id}`, {
         method: "GET",
         headers: {
...
export const useRecordUserData = (id) => {
   return useQuery(["record-user", id], fetchRecordUser, {
