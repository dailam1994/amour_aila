            ...
            <Box sx={{ m: '10px' }}>
                <TableContainer component={Paper}>
                    <Table aria-label="simple table">
                        <TableHead>
                            <TableRow>
                                <TableCell style={{ color: 'rgb(0,0,0)' }}><strong>Upcoming Dates</strong></TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {
                                    ...
                                    return (
                                        <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }} key={i}>
                                            <TableCell component="th" scope="row" sx={{ my: 0, py: 0 }}>
                                                <Link to='' style={{ color: 'rgb(0,0,0)' }}>{i}</Link>
                                            </TableCell>
                                            <TableCell component="th" scope="row" sx={{ display: 'flex', justifyContent: 'flex-end', pr: '5px', my: 0, py: 0 }}>
                                                <Link style={{ 'marginLeft': '3px', 'marginRight': '0', float: 'right' }} to={`/schedule-add/${i}`}>
                                                    <Button variant='contained' color='success'>Set Time</Button>
                                                </Link>
                                            </TableCell>
                                        </TableRow>
                                    )
            ...
            <Container sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', my: '10px', p: 0 }}>
                <Box>
                    <Link to={'/schedule-view'}>
                        <Button variant='contained' color='primary'>View Schedules</Button>
                    </Link>
                </Box>
                <Box>
                    <Link to={'/date-add'}>
                        <Button variant='contained' color='secondary'>Set Date/Time</Button>
                    </Link>
                </Box>
            </Container>
        </>
