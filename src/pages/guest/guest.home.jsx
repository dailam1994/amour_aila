...
const GuestHome = () => {
    const carouselList = [
        {
            id: 1,
            src: "../assets/img/carousel-food-wood-dawn-fashion.jpg",
            alt: "carousel-food-wood-dawn-fashion"
        },
        {
            id: 2,
            src: "../assets/img/carousel-woman-in-blue-t-shirt-and-blue-shorts-sitting-on-bed.jpg",
            alt: "carousel-woman-in-blue-t-shirt-and-blue-shorts-sitting-on-bed"
        },
        {
            id: 3,
            src: "../assets/img/carousel-wood-fashion-hands-people.jpg",
