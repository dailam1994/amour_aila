    ...
    return (
        <>
            ...
            <Grid container spacing={2} sx={{ my: '10px' }} style={{ borderLeft: "21px solid rgb(50,53,101)" }}>
                <Grid item xs={6} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }} style={{ padding: '0px' }}>
                    <Typography sx={{ m: '10px' }} variant='h4'>
                        <strong>Mrs. <br /> Aila</strong>
                    </Typography>
                </Grid>
                <Grid item xs={6} style={{ padding: '0px' }}>
                    <img
                        ...
                        style={{ width: '100%' }}
                        src={"../assets/img/blog-side-view-of-a-woman-in-portrait-photography.jpg"}
